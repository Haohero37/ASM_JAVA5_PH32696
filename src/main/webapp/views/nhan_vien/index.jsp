...
<div class="container">
    ...
    <form class="row" action="/cua-hang/nhan-vien/index" method="get">
        <div class="col mb-3">
            <label for="nameormanv" class="form-label">Tên/Mã Nhân Viên</label>
            <input type="text" class="form-control" id="nameormanv" value="${nameormanv}" name="nameormanv">
        </div>
        <div class="col mb-3">
        ...
        <div class="col mt-4  mb-3">
            <div class="row">
                ...
                <c:if test="${not empty nameormanv || not empty trangThai}">
                    <button type="submit" class="col btn btn-warning">
                        <a href="/cua-hang/nhan-vien/index">Hủy Bộ Lọc</a>
                    </button>
                </c:if>
            </div>
        </div>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tbody>
        <c:forEach items="${lstNhanVien.content}" var="nv">
            <tr>
                <td>${nv['id']}</td>
                <td>${nv['ma']}</td>
                <td>${nv['ten']}</td>
                ...
                <td>${nv['trangThai']}</td>
                <td>
                    <a class="btn btn-warning" href="/cua-hang/nhan-vien/edit/${nv['id']}">Edit</a>
                    <a class="btn btn-danger" href="/cua-hang/nhan-vien/remove/${nv['id']}">Remove</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="row">
        <div class="col">
            <a class="btn btn-success "  href="/cua-hang/nhan-vien/create">Thêm Mới Nhân Viên</a>
        </div>
    </div>
</div>
</body>
