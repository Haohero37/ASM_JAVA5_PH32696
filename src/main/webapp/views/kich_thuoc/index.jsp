...
<body>
<div class="container">
    <h1 class="center">Danh Sách Kích Thước</h1>
    <form class="row" action="/cua-hang/kich-thuoc/index" method="get">
        <div class="col mb-3">
            <label for="nameormakt" class="form-label">Tên/Mã Kích Thước</label>
            <input type="text" class="form-control" id="nameormakt" value="${nameormakt}" name="nameormakt">
        </div>
        <div class="col mb-3">
        ...
        <div class="col mt-4  mb-3">
            <div class="row">
                ...
                <c:if test="${not empty nameormakt || not empty trangThai}">
                    <button type="submit" class="col btn btn-warning">
                        <a href="/cua-hang/kich-thuoc/index">Hủy Bộ Lọc</a>
                    </button>
                </c:if>
            </div>
        </div>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tbody>
        <c:forEach items="${lstKichThuoc.content}" var="kt">
            <tr>
                <td>${kt['id']}</td>
                <td>${kt['ma']}</td>
                <td>${kt['ten']}</td>
                <td>${kt['trangThai']}</td>
                <td>
                    <a class="btn btn-warning" href="/cua-hang/kich-thuoc/edit/${kt['id']}">Edit</a>
                    <a class="btn btn-danger" href="/cua-hang/kich-thuoc/remove/${kt['id']}">Remove</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="row">
        <div class="col">
            <a class="btn btn-success "  href="/cua-hang/kich-thuoc/create">Thêm Mới Kích Thước</a>
        </div>
    </div>
</div>
</body>
