...
<body>
    <div class="container">
        ...
        <form  action="/cua-hang/khach-hang/update" method="post">
            <div class="mb-3">
                <label class="form-label" for="id">ID</label>
                <input class="form-control" type="text" id="id" name="id" value="${KhachHang.id}" readonly>
            </div>
            <div class="mb-3">
            ...
            <a  href="/cua-hang/khach-hang/index" class="btn btn-success mb-3 ">Quay Lại Trang Chủ</a>
        </form>
    </div>
</body>
</html>