...
<div class="container">
    ...
    <form class="row" action="/cua-hang/khach-hang/index" method="get">
        <div class="col mb-3">
            <label for="nameorsdt" class="form-label">Tên/SDT Khách Hàng</label>
            <input type="text" class="form-control" id="nameorsdt" value="${nameorsdt}" name="nameorsdt">
        </div>
        <div class="col mb-3">
            ...
            <div class="row">
                ...
                <c:if test="${not empty nameormams || not empty trangThai}">
                    <button type="submit" class="col btn btn-warning">
                        <a href="/cua-hang/khach-hang/index">Hủy Bộ Lọc</a>
                    </button>
                </c:if>
            </div>
        </div>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tbody>
        <c:forEach items="${lstKhachHang.content}" var="kh">
            <tr>
                <td>${kh['id']}</td>
                <td>${kh['ma']}</td>
                <td>${kh['ten']}</td>
                ...
                <td>${kh['trangThai']}</td>
                <td>
                    <a class="btn btn-warning" href="/cua-hang/khach-hang/edit/${kh['id']}">Edit</a>
                    <a class="btn btn-danger" href="/cua-hang/khach-hang/remove/${kh['id']}">Remove</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="row">
        <div class="col">
            <a class="btn btn-success "  href="/cua-hang/khach-hang/create">Thêm Mới Khách Hàng</a>
        </div>
    </div>
</div>
</body>
